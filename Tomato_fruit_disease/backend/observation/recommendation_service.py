...
MONITORING_GUIDANCE = {
    "early_blight": {
        ...
        "note": "This is observation-based monitoring guidance, not a treatment prescription.",
    },
    "late_blight": {
        ...
        "note": "Weather context may indicate favourable conditions; it does not alone prove progression.",
    },
    "leaf_miner": {
        ...
        "note": "Relative severity trend is based on pseudo-severity labels, not expert ground truth.",
    },
    "anthracnose": {
        ...
        "note": "Observation-based monitoring guidance for fruit cases.",
    },
    "blossom_end_rot": {
        ...
        "note": "Relative severity reflects pseudo-labels until expert labels are collected.",
    },
    "spotted_wilt_virus": {
        ...
        "note": "Visual consistency does not guarantee the same plant identity.",
    },
}
...
def get_worsening_recommendation(
    ...
    if not guidance:
        guidance = {
            ...
            "note": "Generic observation-based monitoring guidance.",
        }
