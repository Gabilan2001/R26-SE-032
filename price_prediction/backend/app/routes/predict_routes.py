...
def predict_price(request: PricePredictionRequest):
    ...
    try:
        ...
        response_payload = PricePredictionResponse(
            ...
            action_code=rec_dict.get("action_code", "STABLE"),
            peak_price_lkr=rec_dict.get("peak_price_lkr"),
            peak_day=rec_dict.get("peak_day"),
            peak_change_pct=rec_dict.get("peak_change_pct"),
            terminal_change_pct=rec_dict.get("terminal_change_pct"),
            post_peak_drop_pct=rec_dict.get("post_peak_drop_pct"),
            trend=rec_dict.get("trend"),
            optimal_sell_day=rec_dict.get("optimal_sell_day"),
            optimal_sell_price_lkr=rec_dict.get("optimal_sell_price_lkr"),
