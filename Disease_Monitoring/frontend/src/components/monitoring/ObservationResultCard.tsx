...
const styles = StyleSheet.create({
  ...
  dateLabel: { color: palette.textMuted, marginTop: 4 },
  image: {
    width: "100%",
    height: 200,
    borderRadius: 12,
  ...
  changeLabel: { color: palette.textMuted, fontWeight: "600", width: 64 },
  ...
  trendValue: { color: palette.infoText, fontWeight: "800", fontSize: 16 },
  baselineHint: { color: palette.textMuted, marginTop: 10, lineHeight: 18 },
  statusCard: {
    marginTop: 12,
    backgroundColor: palette.card,
    borderRadius: 14,
  ...
  statusOk: { color: palette.accent, fontWeight: "700", marginTop: 6, fontSize: 15 },
});
