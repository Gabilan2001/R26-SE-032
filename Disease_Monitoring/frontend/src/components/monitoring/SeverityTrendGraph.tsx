          ...
          {points.map((pt, i) => {
            ...
            return (
              <React.Fragment key={pt.observationNumber}>
                ...
                <Circle cx={cx} cy={cy} r={r} fill={color} stroke={palette.card} strokeWidth={2} />
                <SvgText
                  x={cx}
                  y={PAD_T + CHART_H + 18}
                  fill={pt.isPeak ? palette.accent : palette.textMuted}
                  fontSize={10}
...
const styles = StyleSheet.create({
  ...
  title: { color: palette.textPrimary, fontWeight: "700", fontSize: 15 },
  ...
  tooltipTitle: { color: palette.textMuted, fontSize: 11, fontWeight: "600" },
  tooltipValue: { fontSize: 16, fontWeight: "800", marginTop: 4 },
  tooltipPeak: { color: palette.accent, fontSize: 11, fontWeight: "700", marginTop: 4 },
  singleHint: { color: palette.textMuted, fontSize: 11, marginTop: 8, lineHeight: 16 },
});
