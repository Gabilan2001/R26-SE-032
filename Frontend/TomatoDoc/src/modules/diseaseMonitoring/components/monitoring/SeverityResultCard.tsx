...
function makeStyles(p: MonitoringPalette) {
  return StyleSheet.create({
    ...
    label: { color: p.textMuted, fontSize: 12, fontWeight: "600", alignSelf: "flex-start" },
    band: { fontSize: 28, fontWeight: "800", marginTop: 4, alignSelf: "flex-start" },
    score: { color: p.textPrimary, fontWeight: "600", marginTop: 4 },
    hint: { color: p.textMuted, fontSize: 11, marginTop: 6, textAlign: "center" },
  });
}
